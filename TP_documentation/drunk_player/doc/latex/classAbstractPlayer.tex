...
Lecteur de video (classe abstraite). todo \+: implémenter un lecteur classique qui lit toutes les vidéos à la suite bug \+: le son n\textquotesingle{}est pas géré 
...
Retourne la taille maximale des vidéos. Ne distingue pas largeur/hauteur. \index{Abstract\+Player@{Abstract\+Player}!is\+Finished@{is\+Finished}}
